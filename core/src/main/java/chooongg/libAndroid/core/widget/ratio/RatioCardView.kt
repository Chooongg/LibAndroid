...
class RatioCardView @JvmOverloads constructor(
    ...
    init {
        val array: TypedArray = context.obtainStyledAttributes(attrs, R.styleable.RatioCardView)
        val sizeRatio: String? = array.getString(R.styleable.RatioCardView_sizeRatio)
